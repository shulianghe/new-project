...
int cgiMain(void){
    ...
    char filePathOnClient[128] = "/home/zyb/install/cgic205/";
    ...
    strcat(filePathOnClient,name+t+1);
    ...
    targetFile=open(filePathOnClient,O_RDWR|O_CREAT|O_TRUNC|O_APPEND,mode);
    if(targetFile<0){
    ...
    #if DEBUG
    printf("Client file create success!\n");
    #endif
